...
val split_text = text_rdd.flatMap(_.split(" "))
val map_text = split_text.map((_,1))
val reduce_text = split_text.reduce(_+_)
println(reduce_text.take(10).mkString("\n"))
//println(tuple_text.take(10).mkString("\n"))
